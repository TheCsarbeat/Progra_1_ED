...
public:
    ...
    QLabel *lbNameBanda1;
    QLabel *lbNameBanda2;
    QLabel *lbDatosBanda1;
    QLabel *lbDatosBanda2;
    QLabel *lbNameBanda1_2;
    QLabel *lbDatosEnsambladora;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lbNameBanda1 = new QLabel(factoryPanel);
        lbNameBanda1->setObjectName(QString::fromUtf8("lbNameBanda1"));
        lbNameBanda1->setGeometry(QRect(340, 480, 91, 41));
        lbNameBanda2 = new QLabel(factoryPanel);
        lbNameBanda2->setObjectName(QString::fromUtf8("lbNameBanda2"));
        lbNameBanda2->setGeometry(QRect(520, 480, 91, 41));
        lbDatosBanda1 = new QLabel(factoryPanel);
        lbDatosBanda1->setObjectName(QString::fromUtf8("lbDatosBanda1"));
        lbDatosBanda1->setGeometry(QRect(280, 530, 151, 41));
        lbDatosBanda2 = new QLabel(factoryPanel);
        lbDatosBanda2->setObjectName(QString::fromUtf8("lbDatosBanda2"));
        lbDatosBanda2->setGeometry(QRect(470, 530, 141, 41));
        lbNameBanda1_2 = new QLabel(factoryPanel);
        lbNameBanda1_2->setObjectName(QString::fromUtf8("lbNameBanda1_2"));
        lbNameBanda1_2->setGeometry(QRect(690, 480, 91, 41));
        lbDatosEnsambladora = new QLabel(factoryPanel);
        lbDatosEnsambladora->setObjectName(QString::fromUtf8("lbDatosEnsambladora"));
        lbDatosEnsambladora->setGeometry(QRect(640, 530, 141, 41));
        lbDatosBandaHorno = new QLabel(factoryPanel);
        lbDatosBandaHorno->setObjectName(QString::fromUtf8("lbDatosBandaHorno"));
        lbDatosBandaHorno->setGeometry(QRect(810, 530, 151, 41));
        lbNameBandaHorno = new QLabel(factoryPanel);
        lbNameBandaHorno->setObjectName(QString::fromUtf8("lbNameBandaHorno"));
        lbNameBandaHorno->setGeometry(QRect(820, 480, 91, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lbNameBanda1->setText(QCoreApplication::translate("MainWindow", "Banda 1", nullptr));
        lbNameBanda2->setText(QCoreApplication::translate("MainWindow", "Banda 2", nullptr));
        lbDatosBanda1->setText(QCoreApplication::translate("MainWindow", "Datos", nullptr));
        lbDatosBanda2->setText(QCoreApplication::translate("MainWindow", "Datos", nullptr));
        lbNameBanda1_2->setText(QCoreApplication::translate("MainWindow", "Ensambladora", nullptr));
        lbDatosEnsambladora->setText(QCoreApplication::translate("MainWindow", "Datos", nullptr));
